...
export default function GalleryPage() {
  ...
  const getPhotosCountForCategory = (categoryName: string) => {
    return photos.filter((photo) => photo.category_name === categoryName).length
  }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {isLoading && (
            <div className="flex justify-center items-center py-20">
              ...
              <span className="ml-3 text-gray-600 text-lg font-light">Loading gallery...</span>
            </div>
          )}
          ...
          {/* Lightbox Modal */}
          {lightboxOpen && filteredPhotos.length > 0 && filteredPhotos[currentPhotoIndex] && (
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 rounded-b-lg">
                    ...
                    <div className="flex justify-between items-center">
                      <p className="text-white/70 text-sm font-light">
                        Category: {filteredPhotos[currentPhotoIndex]?.category_name}
                      </p>
                      <p className="text-white/70 text-sm font-light">
